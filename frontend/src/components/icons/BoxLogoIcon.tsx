...
export const BoxLogoIcon = (props: SvgIconProps) => {
  return (
    <SvgIcon width="41" height="22" viewBox="0 0 41 22" {...props}>
      {/* https://en.m.wikipedia.org/wiki/File:Box,_Inc._logo.svg */}
      <svg xmlns="http://www.w3.org/2000/svg" width="41" height="22" fill="currentColor">
